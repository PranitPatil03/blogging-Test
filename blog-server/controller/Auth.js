...
import { generateUsername } from "../services/services.js";
import { formatDataToSend } from "../services/services.js";
import { emailRegex } from "../server.js";
import { passwordRegex } from "../server.js";
...
export const loginUser = async (req, res) => {
  try {
    ...
    if (!user.google_auth) {
      ...
      return res
        .status(403)
        .json({ error: "This email is already used by Google" });
    }
  } catch (err) {
    return res.status(500).json({ error: err.message });
  }
